...
# 2016
pufile_dataUL2016 = "%s/src/PhysicsTools/NanoAODTools/python/postprocessing/data/pileup/PileupHistogram-2016preVFP-99bins_withVar.root" % os.environ['CMSSW_BASE']
pufile_mcUL2016 = "%s/src/PhysicsTools/NanoAODTools/python/postprocessing/data/pileup/mcPileupUL2016.root" % os.environ['CMSSW_BASE']
...
pufile_mcUL2017 = "%s/src/PhysicsTools/NanoAODTools/python/postprocessing/data/pileup/mcPileupUL2017.root" % os.environ['CMSSW_BASE']
...
# 2018
pufile_dataUL2018 = "%s/src/PhysicsTools/NanoAODTools/python/postprocessing/data/pileup/PileupHistogram-2018-99bins_withVar.root" % os.environ['CMSSW_BASE']
pufile_mcUL2018 = "%s/src/PhysicsTools/NanoAODTools/python/postprocessing/data/pileup/mcPileupUL2018.root" % os.environ['CMSSW_BASE']
...
pufile_dataUL2022PreEE = "%s/src/PhysicsTools/NanoAODTools/python/postprocessing/data/pileup/PileupHistogram-2022preEE-99bins_withVar.root" % os.environ['CMSSW_BASE']
puAutoWeight_UL2022PreEE = lambda: puWeightProducer(
    "auto", pufile_dataUL2022PreEE, "pu_mc", "pileup", verbose=False)

pufile_dataUL2022PostEE = "%s/src/PhysicsTools/NanoAODTools/python/postprocessing/data/pileup/PileupHistogram-2022postEE-99bins_withVar.root" % os.environ['CMSSW_BASE']
puAutoWeight_UL2022PostEE = lambda: puWeightProducer(
    "auto", pufile_dataUL2022PostEE, "pu_mc", "pileup", verbose=False)

pufile_dataUL2023PreBpix = "%s/src/PhysicsTools/NanoAODTools/python/postprocessing/data/pileup/PileupHistogram-2023preBPix-99bins_withVar.root" % os.environ['CMSSW_BASE']
puAutoWeight_UL2023PreBpix = lambda: puWeightProducer(
    "auto", pufile_dataUL2023PreBpix, "pu_mc", "pileup", verbose=False)

pufile_dataUL2023PostBpix = "%s/src/PhysicsTools/NanoAODTools/python/postprocessing/data/pileup/PileupHistogram-2023postBPix-99bins_withVar.root" % os.environ['CMSSW_BASE']
puAutoWeight_UL2023PostBpix = lambda: puWeightProducer(
    "auto", pufile_dataUL2023PostBpix, "pu_mc", "pileup", verbose=False)